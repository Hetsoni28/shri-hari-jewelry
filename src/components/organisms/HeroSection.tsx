...
export default function HeroSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full h-screen min-h-[560px] max-h-[1000px] overflow-hidden bg-black"
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-black/20"                           style={{ zIndex: 1 }} />
      <div className="absolute inset-0 bg-gradient-to-r from-black/55 via-black/5 to-transparent"                            style={{ zIndex: 1 }} />
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_transparent_55%,_rgba(0,0,0,0.25)_100%)]"     style={{ zIndex: 1 }} />

      {/* ── Content Layer (also parallaxes slightly) ── */}
      <motion.div
        className="absolute inset-0 flex flex-col justify-between px-5 sm:px-8 md:px-14 pt-28 pb-8 sm:pt-32 sm:pb-10 md:pt-40 md:pb-12"
          ...
          <div className="w-full max-w-3xl">
            ...
            <div className="mb-4">
              {[['A TRULY', 'MAGICAL'], ['JEWELRY', 'JOURNEY.']].map((line, li) => (
                <div key={li} className="overflow-hidden py-3 -my-3">
                  <div className="flex flex-wrap gap-x-[0.28em]">
                    {line.map((word, wi) => (
                      <motion.span
                        ...
                        className={`inline-block text-headline text-[1.9rem] sm:text-5xl md:text-6xl lg:text-[78px] xl:text-[92px] font-bold leading-[0.95] tracking-tight drop-shadow-2xl ${
            ...
            <motion.p
              ...
              className="text-white/75 text-[11px] sm:text-sm leading-relaxed mb-8 max-w-sm drop-shadow-md font-body"
            >
            ...
            >
              ...
              >
                <Link
                  href="/catalog"
                  className="inline-block bg-[#C9A84C] hover:brightness-110 text-white py-3.5 px-8 text-[10px] sm:text-xs font-bold tracking-[0.2em] uppercase transition-[filter] duration-300 shadow-2xl"
                >
                  View Collection
                </Link>
              </motion.div>
              ...
              >
                <Link
                  href="/contact"
                  className="inline-block border border-white/40 hover:border-white text-white py-3.5 px-8 text-[10px] sm:text-xs font-bold tracking-[0.2em] uppercase transition-colors duration-300 backdrop-blur-sm"
                >
                  Contact Us
                </Link>
              </motion.div>
